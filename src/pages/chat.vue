<template>
    ...
    <div style="overflow-x: auto; height: 500px">
      <div v-for="chat in messages" :key="chat.id">
        <div class="d-flex flex-row-reverse my-3">
          <div class="rounded mx-4 p-2 bg-success text-white">
            {{ chat.message }}
          </div>
        </div>
        <div
          class="font-weight-bold text-secondary time d-flex flex-row-reverse mx-4 px-2"
        >
          {{ chat.time }}
        </div>
        ...
        <div class="font-weight-bold text-secondary time mx-4 px-2 text-left">
          {{ chat.time }}
        </div>
      </div>
    </div>
  ...
  <div class="input-group d-flex footer justify-content-center p-5">
    ...
    <div class="input-group-append">
      <button v-on:click="sendMessage" class="input-group-text">
